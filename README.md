...
#### _This is a web-based application wherein the user can enter a city and have the weather and humidity returned in the browser._
...
## Project Title: Weather API Search
...
- _Clone this project using ```$ git clone https://github.com/johnwhittenstudio/weather```_

- _Navigate to the top level of the directory with the command ```$ cd weather```_
